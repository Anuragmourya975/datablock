  ...
  return (
    <div>
      <aside className="w-64" aria-label="Sidebar">
        <div className="overflow-y-auto py-4 px-3 h-screen bg-gray-50 rounded dark:bg-gray-900">
          ...
          >
            ...
            <p className="mb-3 text-sm text-blue-900 dark:text-blue-400">
              ...
              velit aut nemo quo ad aspernatur error deserunt non a, fugit odio,
              ex ullam maxime. Blanditiis!
            </p>
            <a
